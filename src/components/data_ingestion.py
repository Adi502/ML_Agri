...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            df = pd.read_csv("./data/Crop_recommendation.csv")   #Reading the data
            ...
            train_set.to_csv(self.ingestion_config.train_data_path,index=True,header=True)  #saving to particular paths
