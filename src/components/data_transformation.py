...
@dataclass  #The @dataclass decorator is used to create a dataclass in Python. A dataclass is a special type of class that is designed to store data.
...
class DataTransformation:
    ...
    def get_data_transformer_object(self): #This function is responsible for data transformation
        try:
            numerical_coulmns = ["N","P","K","temperature","humidity","ph","rainfall"]

            num_pipeline = Pipeline(
                steps = [
                    ("imputer",SimpleImputer(strategy="median")), #imputer is responsible to handle the missing values; median strategy is used because there are outliers
