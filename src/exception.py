...
class CustomException(Exception):
    def __init__(self,error_message,error_detail:sys): # The above function is a constructor that initializes an object with an error message and error detail.
